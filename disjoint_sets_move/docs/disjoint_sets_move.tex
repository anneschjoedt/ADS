...
\title{Disjoint Sets -- Union Find Move}
\author{}
...
\begin{abstract}
  ...
  To solve this exercise, you need construct a new data structure, instead of just taking a well-known solution off the shelf, as we did
  in other exercises.
  % for Disjoint Sets II, or slighly extending a well-known solution, as we did for Disjoint Sets III.
...
\begin{description}
  \item[Source code of solution.]
    ...
    Hand this in as \texttt{DSufm.java} or \texttt{DSufm.py}.
...
\newpage
\section{Report: Disjoint Sets -- union find move}
...
by Alice Cooper, Bob Marley, and Charlie Brown\sidenote{Complete the report by filling
  ...
  Program \texttt{DSufm} passes all tests on the CodeJudge, with a maximum of running time of 4 seconds.
