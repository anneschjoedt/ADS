...
Here, time is the number of edges that have been added for the event to occur, i.e., if we say that the graph of 10 nodes had a giant component for the first time at time 7 it means that we added precisely 7 edges to create a component of 6 vertices.
