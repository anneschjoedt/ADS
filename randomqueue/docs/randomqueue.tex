...
\end{fullwidth}
\end{quotation}
Note that there is no notion of public, the types are slightly different and there are no generic types in python, so your RandomQueue will be a collection of Objects of arbitrary type. 
...
\begin{enumerate}
\item {\tt RandomQueue.java} or {\tt RandomQueue.py} and a report
